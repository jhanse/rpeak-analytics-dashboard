...
- Project setup analytics: first task/start → green light; green light → first patient.
...
The bundled CSV is included for reproducibility. Uploaded replacement datasets are parsed locally in the browser and stored in browser localStorage only.
